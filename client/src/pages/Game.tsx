...
export default function Game() {  
  ...
  const {password, setPassword, showPasswordModal, joinWithPassword, passwordError, joinError, isJoining} = useJoinGame(params.gameId ?? "")
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center gap-10 overflow-y-auto">
      ...
      {isJoining && (
        <svg aria-hidden="true" className="w-8 h-8 animate-spin text-wrong fill-correct" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Modal isOpen={gameStatus === "waiting" && !showPasswordModal && !isJoining}>
